                ...
                <div class="container">
                    {
                        lang.lang == "ru"
                            ...
                            <div class="mt-4">
                                ...
                                <p>1.1. Индивидуальный Предприниматель Овчинникова Юлия Игоревна, ИНН 344103083881, ОГРНИП 321344300027087, публикует публичную оферту о продаже товаров, представленным в официальном интернет-магазине Продавца www.lemousse.beauty.</p>
                                ...
                                <p>Продавец обязуется не сообщать данные Покупателя в интернет-магазине www.lemousse.beauty, а также иную информацию, касающуюся личных данных Покупателя, лицам, не имеющим отношения к исполнению Заказа.</p>
                                ...
                                <p>Заказы, поступившие из интернет-магазина www.lemousse.beautyобрабатываются ежедневно (в течении 7 дней) кроме субботы, воскресения и официально праздничных дней на Территории РФ.</p>
                                ...
                                <p>6.2. Цена на Товар отображена в рублях в интернет-магазине www.lemousse.beauty</p>
                                ...
                                <p>7.5. Вся текстовая информация и графические изображения, размещенные в интернет-магазине www.lemousse.beautyи в аккаунте инстаграм @le__mousse, являются собственностью Продавца и/или его поставщиков и производителей.</p>
                                <p><strong>8. Права, обязанности и ответственность</strong></p>
                                <p>8.1. Продавец не несет ответственности за ненадлежащее использование товаров Покупателем, заказанных в интернет-магазине www.lemousse.beauty</p>
