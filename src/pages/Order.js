              ...
              <table style={{ width: '100%', maxWidth: 'none' }}>
                ...
                <tbody id="table-cart">
                  <tr className="item" data-price={1790} data-product={2} data-shipping={1}>
                    <td><span className="cart-item__name">Скраб для тела с ароматом летнего дождя (250мл (280г))</span><br /><span style={{ fontSize: '.8em' }}>Артикул: scrub-ld</span></td>
                    ...
                    <td>
                      <div className="d-flex justify-content-center align-items-center box-quantity" style={{ marginLeft: 'auto', marginRight: 'auto' }}>
                        <a className="minus" />
                        <input type="text" name="quantity" className="quantity" defaultValue={1} style={{ paddingLeft: 0, paddingRight: 0 }} disabled />
                        <a className="plus" />
                      </div>
                    </td>
                    <td>
                    ...
                    <td className="d-none d-sm-table-cell">
                      <a href="https://thebestforyourself.ru/cart/remove?product_id=2" style={{ color: '#fff' }}>Х</a></td>
                  </tr>
                </tbody>
              </table>
            </div>
